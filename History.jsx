...
const History = ({ data, loading, onRefresh }) => {
  ...
  const getAnimalIcon = (animal) => {
    const icons = {
      ...
      'jirafa': '🦒', 'culebra': '🐍', 'tortuga': '🐢', 'búfalo': '🐃', 'lechuza': '🦉',
      'avispa': '🐝', 'canguro': '🦘', 'tucán': '🦜', 'mariposa': '🦋', 'chigüire': '🦫',
      'garza': '🦢', 'puma': '🐆', 'pavo real': '🦚', 'puercoespín': '🦔', 'pereza': '🦥',
      'canario': '🐤', 'pelícano': '🦆', 'pulpo': '🐙', 'caracol': '🐌', 'grillo': '🦗',
      'oso hormiguero': '🐻', 'tiburón': '🦈', 'pato': '🦆', 'hormiga': '🐜', 'pantera': '🐆',
      'camaleón': '🦎', 'panda': '🐼', 'cachicamo': '🦔', 'cangrejo': '🦀', 'gavilán': '🦅',
      'araña': '🕷️', 'lobo': '🐺', 'avestruz': '🦤', 'jaguar': '🐆', 'conejo': '🐰',
      'bisonte': '🦬', 'guacamaya': '🦜', 'gorila': '🦍', 'hipopótamo': '🦛', 'turpial': '🐦',
      'guácharo': '🦇', 'ballena': '🐋'
    };
