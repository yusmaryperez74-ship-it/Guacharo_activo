          ...
          {data.por_hora && Object.keys(data.por_hora).length > 0 ? (
            <div style={{ display: 'flex', flexDirection: 'column', gap: '0.5rem' }}>
              {Object.entries(data.por_hora)
                ...
                .slice(0, 10)
                .map(([hora, cantidad]) => {
                  const maxCantidad = Math.max(...Object.values(data.por_hora));
                  ...
                  return (
                    <div key={hora} style={{
                      ...
                      <div style={{ width: '80px', fontWeight: '500' }}>
                        🕐 {hora}
                      </div>
                      ...
                      <div style={{ width: '40px', textAlign: 'right', fontWeight: 'bold', fontSize: '0.875rem' }}>
                        {cantidad}
                      </div>
                    </div>
                  );
